...
(function () {
  ...
  const SUBJECT_META = {
    scratch:        { short: "Scratch",  org: "电子学会", color: "#3b82f6" },
    python:         { short: "Python",   org: "电子学会", color: "#2563eb" },
    robot:          { short: "机器人",   org: "电子学会", color: "#0ea5e9" },
    c:              { short: "C语言",     org: "电子学会", color: "#0284c7" },
    "lanqiao-scratch": { short: "Scratch", org: "蓝桥杯", color: "#f59e0b" },
    "lanqiao-python":  { short: "Python",  org: "蓝桥杯", color: "#d97706" },
    "lanqiao-c":       { short: "C语言",   org: "蓝桥杯", color: "#b45309" },
    "gesp-scratch":    { short: "Scratch", org: "GESP",  color: "#8b5cf6" },
    "gesp-python":     { short: "Python",  org: "GESP",  color: "#7c3aed" },
    "gesp-cpp":        { short: "C++",     org: "GESP",  color: "#6d28d9" },
    oi:             { short: "信息学奥赛", org: "CSP",   color: "#dc2626" },
    "info-scratch":    { short: "Scratch", org: "信息素养", color: "#059669" },
    "info-python":     { short: "Python",  org: "信息素养", color: "#047857" },
    "info-c":          { short: "C语言",   org: "信息素养", color: "#065f46" },
  };
  const metaOf = (k) => SUBJECT_META[k] || { short: k, org: "", color: "#64748b" };
