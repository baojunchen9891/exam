  ...
  function renderNav(active) {
    ...
    const leftNav = `
      <div class="brand">
        ...
        <div class="navtabs">
          <a href="${BASE}index.html" class="${activeClass("home")}">网站首页</a>
          ...
          <a href="${BASE}diagnostic.html" class="${activeClass("diagnose")}">免费诊断<span class="nav-soon">内测</span></a>
          <a href="${BASE}cspjsjixun.html" class="${activeClass("csp")}">CSP 集训</a>
